<template>
  <div class="header">
    <div class="left">
      ...
      <router-link to="/company-list" class="company element"
        >Firmy</router-link
      >
      <router-link
        to="/update-company"
        ...
        v-if="isCompany()"
        >Moja Firma</router-link
      >
      <router-link
        to="/company-offers-list"
        class="company element"
        v-if="isCompany()"
        >Moje Oferty</router-link
      >
    </div>
    <div class="right">
      <router-link to="/sign-in" class="login element" v-if="!islogin"
        >Zaloguj</router-link
      >
      <router-link to="/sign-up" class="register element" v-if="!islogin"
        >Zarejestruj</router-link
      >
      <div class="profile element" v-if="islogin" @click="toggleDropdown">
        {{ email }}
        <div v-if="dropdownVisible" class="dropdown-menu">
          <router-link to="/change-password" v-if="!isExternal()"
            >Zmiana hasła</router-link
          >
