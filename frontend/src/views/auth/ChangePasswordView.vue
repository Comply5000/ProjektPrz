    ...
    <div class="vue-template">
      ...
      <div class="card">
        ...
        <div class="mb-3">
          ...
          <input type="password" id="currentPassword" class="form-control form-control-lg" v-model="form.currentPassword" required>
        </div>
        <div class="mb-3">
          <label for="password"> Podaj nowe Hasło:</label>
          <input type="password" id="newPassword" class="form-control form-control-lg" v-model="form.newPassword" required>
        </div>
        <div class="mb-3">
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      axios.post(`/user-identity/change-password`, this.form, {
        headers: {
